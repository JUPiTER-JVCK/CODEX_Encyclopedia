...
- 231 files carry a diagram across the repository. The diagram audit
  requires one of 272 files, and 228 of those carry it; the other three
  ...
  the remaining 44 are listed in `tools/diagram_backlog.txt`, checked in both
