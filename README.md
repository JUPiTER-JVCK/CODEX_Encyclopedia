...
- 154 files carry a diagram across the repository. The diagram audit
  requires one of 272 files, and 151 of those carry it; the other three
  ...
  the remaining 121 are listed in `tools/diagram_backlog.txt`, checked in both
